<?php
    ...
    $query = "SELECT * FROM asistent where position_lab = 'Mekanika Fluida'";
...
<html lang="en">
    <head>
        ...
        <title>Lab. Mekanika Fluida</title>
        <!-- Bootstrap CSS -->
                        ...
                        <div class="single-post row">
                            <div class="col-lg-12">
                                <div class="feature-img">
                                    <img class="img-fluid" src="../img/history/result/lab mekanika fluida.png" alt="">
                                </div>									
                            </div>
                            <div class="col-lg-12 col-md-9 blog_details">
                                <h2>Laboratorium Mekanika Fluida</h2>
                                <p class="excert">
                                    Laboratorium Mekanika Fluida/Hidrodinamika yaitu laboratorium yang berfungsi untuk penelitian, pendukung praktikum yang dilengkapi dengan peralatan tekanan aliran, karakteristik turbin pelton dan karakteristik fluida angin serta tekanan angin.
                                </p>
                                <p>
                                    Materi praktikum ini terfokus pada Mekanika Fluida meliputi:
                                    <ol>
                                        <li>Faktor Gesekan</li>
                                        <li>Pompa & Turbin</li>
                                        <li>Pemipaan</li>
                                    </ol>
                                </p>
                                <p>
                                    Praktikum dilaksanakan pada semester 4 dengan syarat lulus matakuliah Mekanika Fluida dan Dinamika Fluida.
                                </p>
                            </div>
                            <!-- Asisten Lab -->
                            <div class="col-lg-12">
                                ...
                                <div class="row mb-4">
                                    <div class="col-6 mb-4">
                                        <img class="img-fluid" src="../img/history/detail/mekanika fluida.png" alt="">
                                    </div>
                                    <div class="col-6 mb-4">
                                        <img class="img-fluid" src="../img/history/detail/mekanika fluida 2.png" alt="">
                                    </div>				
                                </div>
                                <div class="row mb-4">
                                    <div class="col-6 mb-4">
                                        <a href="https://tm.ums.ac.id/laboratorium-mekanika-fluida/" target="_blank"><u class="text-info">Show more →</u></a>
                                    </div>	
                                </div>
                            </div>
                        </div>
