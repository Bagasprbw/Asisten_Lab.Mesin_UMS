<?php
    ...
    $query = "SELECT * FROM asistent where position_lab = 'Komputer'";
                        ...
                        <div class="single-post row">
                            <div class="col-lg-12">
                                <div class="feature-img">
                                    <img class="img-fluid" src="../img/history/result/lab komputer.png" alt="">
                                </div>									
                            </div>
                            <div class="col-lg-12 col-md-9 blog_details">
                                <h2>Laboratorium Komputer</h2>
                                <p class="excert">
                                    Laboratorium Komputer mempelajari terkait gambar mesin yang diambil pada semester 2 dengan syarat lulus matakuliah gambar mesin. Software yang digunakan ditekankan pada software CAD yaitu Autocad.
                                </p>
                                <p>
                                    Laboratorium komputer dapat menampung sebanyak 40 mahasiswa. Mata kuliah yang diajarkan pada lab. Komputer berguna untuk mata kuliah lanjutan, yaitu Tugas Perencanaan Mesin dan Group Project.
                                </p>
                            </div>
                            <!-- asisten -->
                            <div class="col-lg-12">
                                ...
                                <div class="row mb-4">
                                    <div class="col-6 mb-4">
                                        <img class="img-fluid" src="../img/history/detail/autocad.png" alt="">
                                    </div>
                                    <div class="col-6 mb-4">
                                        <img class="img-fluid" src="../img/history/detail/solidwork.png" alt="">
                                    </div>		
                                    <div class="col-6 mb-4">
                                        <img class="img-fluid" src="../img/history/detail/pc.jpg" alt="">
                                    </div>
                                    <div class="col-6 mb-4">
                                        <img class="img-fluid" src="../img/history/detail/printer3d.jpg" alt="">
                                    </div>						
                                </div>	
                                <div class="row mb-4">
                                    <div class="col-6 mb-4">
                                        <a href="https://tm.ums.ac.id/laboratorium-cad-cam-cae/" target="_blank"><u class="text-info">Show more →</u></a>
                                    </div>	
                                </div>
                            </div>
                        </div>
